...
- [x] Профіль гравця з рангами
- [x] Рейтингова система
- [x] Розклад ігор та запис
- [x] Система баз даних (PostgreSQL + SQLAlchemy)
- [x] Docker конфігурація

### 🚧 В розробці

- [ ] Система досягнень (10 базових)
